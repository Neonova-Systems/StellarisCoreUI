...
const commandsList = [
    ...
    { name: "SMART report /dev/nvme0", description: "Run full smartctl report for NVMe controller /dev/nvme0", command: buildSmartCommand("/dev/nvme0"), keybind: "", dontAsync: true},
    { name: "SMART report /dev/nvme1", description: "Run full smartctl report for NVMe controller /dev/nvme1", command: buildSmartCommand("/dev/nvme1"), keybind: "", dontAsync: true},
