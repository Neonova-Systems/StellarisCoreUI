...
const commandsList = [
    { name: "Hide Desktop Icons", description: "Temporarily hide all desktop icons", command: "ags request 'toggleDesktopIcons'", keybind: ""},
    { name: "Refresh Desktop", description: "Reload desktop icons and layout", command: "ags request 'refreshDesktop'", keybind: "F5"},
    { name: "Open Terminal Here", description: "Open terminal in desktop directory", command: "/usr/bin/kitty --directory ~/Desktop", keybind: ""},
    { name: "Open File Manager", description: "Open file manager in desktop directory", command: "/usr/bin/nautilus ~/Desktop", keybind: ""},
