...
const commandsList = [
    ...
    { name: "Pause", description: "Pause the currently playing track.", command: "/usr/bin/playerctl pause", keybind: "space"},
    ...
    { name: "Toggle", description: "Toggle between play and pause states.", command: "/usr/bin/playerctl play-pause", keybind: "t"},
]
